...
export default function Distance({ leg }: DistanceProps) {
  ...
  return (
    <div>
      <p>
        This place is <span className="highlight">{leg.distance.text}</span> away
        from your current location. That would take{" "}
        <span className="highlight">{leg.duration.text}</span> to drive.
      </p>
